...
import java.util.Base64;
 ...
 class DESClient {
	...
	DES des=new DES();
        ...
        String ciphertext = des.encrypt_total(plaintext,"ABCD0123456789AB");
...
class DES {
        ...
        static String decrypt_total(String pt, String k){

            StringBuffer ans=new StringBuffer("");
            StringBuffer plaint=new StringBuffer(pt);
            ...
            DES cipher = new DES();
            for(int i=0;i<Math.ceil(n/16); i++){
                String sub=plaint.substring(temp,temp+16);

                String t= cipher.decrypt(sub, k);
                StringBuffer tem=new StringBuffer(t);
                temp+=16;
                ans.append(tem);
            }
            String plain_text= ans.toString();
            String hexStr=plain_text;
           ...
           static String encrypt_total(String pt, String k){

            int hehe=pt.length();
            int q=hehe%8;
            StringBuffer temp1=new StringBuffer(pt);
            if(q!=0)
            for(int i=0;i<(8-q);i++)
                temp1.append(" ");
           ...
           // System.out.println(pt);
            ...
            DES cipher = new DES();
            for(int i=0;i<Math.ceil(n/64); i++){
                String sub=plaint.substring(temp,temp+16);

                String t= cipher.encrypt(sub, k);
                temp+=64;
                ans.append(t);
            }
            String enc_text= ans.toString();
return enc_text;
        }
